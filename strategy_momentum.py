...
MOM_STOP_LOSS = 0.07  # V30.3: 0.06→0.07, 震荡市给动量更多回旋空间
MOM_TAKE_PROFIT = 0.15  # 固定止盈 15%
MOM_STRENGTH_PERIOD = 10  # 趋势强度计算窗口
MOM_SCORE_MIN  = 0.55  # V30.5: lowered  # V30.1: 0.55→0.65, 只取强动量，过滤震荡市假突破
MOM_MA_SPREAD_MIN = 0.015  # V29: 新增, MA20必须比MA60高1.5%
MOM_RSI_MIN    = 45    # V30.5: lowered    # V30.3: 45→48, 只取中强动量
