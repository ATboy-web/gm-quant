...
使用方法:
    ...
    # cfg = {'rsi_buy': 32, 'strategies': ['MR', 'VRC'], ...}
...
SECTOR_CONFIGS = {
    ...
    '金融': {
        ...
        'strategies': {
            ...
            'VRC':  {'enabled': True,  'weight': 1.0},    # V19.2: 1.5→1.0
    ...
    '煤炭': {
        ...
        'strategies': {
            ...
            'VRC':  {'enabled': True,  'weight': 1.0},    # V20: 1.5→1.0
