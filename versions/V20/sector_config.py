...
SECTOR_CONFIGS = {
    ...
    # ==================================================================
    # 化工 — 中波动、强周期
    # V20: 降低MR权重，新增RT反转确认（化工周期性导致MR反复抄底被套）
    # ==================================================================
    '化工': {
        'vol_group': 'medium',
        'cycle_type': 'cyclical',
        'description': '产品价格周期驱动，RT反转确认+VP结合',
        'strategies': {
            'MR':  {'enabled': True,  'weight': 2.0},    # V20: 2.5→2.0，降低抄底权重
            'RT':  {'enabled': True,  'weight': 2.0},    # V20: 新增反转确认
            'VP':  {'enabled': True,  'weight': 1.5},
            'MOM': {'enabled': True,  'weight': 0.5},    # V20: 0.8→0.5，降低追涨权重
        },
        'rsi_buy': 30,
        'rsi_exit': 78,
        'rsi_deep_oversold': 20,
